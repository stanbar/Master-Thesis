...
%If in trust graph, there exist two nodes -- let's call them Alice and Bob -- who are connected each other in such a way that if the edge would be removed, whole graph would split to two components. 
