...
Everyone can become Wikipedia editor. Editor can create new article or modify existing one. But before the change is publicly available, other editors read the proposed change and vote if it 
