...
But this view is based on static network of connections. We somehow meet Alice, Bob and Charlie, and we gets convinced about their trustworthness. Thus there must be a second way of gaining our trust. Let's modify our trust function by allowing external trust obtaining. $T(n) = \%_n > \xi \lor ETG(n) : (N) \rightarrow \{0,1\}$. 

how to What if we meet new person and he convinces us to be trustworthy, thus becoming "friend".
