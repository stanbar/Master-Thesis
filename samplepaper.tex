...
In Fig \ref{fig:trustgraph100} we can see the resulting trust graph for 100 nodes and $\xi = 0.5$

\begin{figure}[ht]
    \includegraphics[width=9cm]{img/webOfTrust100nodes05xi.png}
    \centering
    \caption{Trust Graph generated by Trust Network algorithm for $\xi=0.5$}
    \label{fig:trustgraph100}
\end{figure} 
