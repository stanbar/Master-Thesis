...
R(end) + S(end) + I(end) = $R_0$ + $S_0$ + $I_0$ + $S_0$

afterand  reduction we get
...
\[x(t) = (1 - \frac{\gamma}{\beta}) \frac{C}{C + e^{-(\beta - \gamma)t}}\]
where 
...
we can plot the function $i(t, \beta)$ for constant $\gamma = 0.2$
